    ...
    <Stack spacing={3} px={20}>
          ...
          <Grid item xs={6} sm={4} md={6} lg={8}>
            <Stack spacing={2}>
              <Select labelId="demo-simple-select-label" defaultValue={student.typeDocument} id="demo-simple-select" label="Type Document">
                ...
                <MenuItem value="identification_card">identity goal</MenuItem>
              </Select>
      ...
      <MainCard>
        <Grid container spacing={3}>
          <Grid item xs={6} sm={4} md={6} lg={4}>
            <Typography variant="h5" fontWeight="bold">
              Seleccionar asignatura a orientar
            </Typography>
          </Grid>
          <Grid item xs={6} sm={4} md={6} lg={8}>
            <Stack spacing={2}>
              <Select labelId="demo-simple-select-label" defaultValue={student.typeSubject} id="demo-simple-select" label="Type Document">
                <MenuItem value="software_development">Filosofia</MenuItem>
                <MenuItem value="machine_learning">Español</MenuItem>
                <MenuItem value="mathematics">Mathematics ||</MenuItem>
                <MenuItem value="mathematics">Calculo</MenuItem>
                <MenuItem value="mathematics">Ingles</MenuItem>
                <MenuItem value="mathematics">Ciencias Naturales</MenuItem>
              </Select>
            </Stack>
          </Grid>
        </Grid>
